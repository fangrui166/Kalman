#include <stdio.h>
#include "Fusion/LowPassFilter.h"
#include "hlog_api.h"
...
void new_LowPassFilter(float cutoffFrequency, LowPassFilter* this_)
{
    ...
    this_->timeConstantSecs = 0.5 * (1.0 / (6.283185307179586 * cutoffFrequency));
...
#ifdef DEBUG
    hlog_printf(HLOG_LVL_INFO, HLOG_TAG_FUSION, "[addWeightedSample] numSamples=%d\n", this_->numSamples);
#endif /* DEBUG */
...
#ifdef DEBUG
        hlog_printf(HLOG_LVL_INFO, HLOG_TAG_FUSION, "[addWeightedSample] set filteredData x=%f, y=%f, z=%f\n",
                this_->filteredData->x, this_->filteredData->y, this_->filteredData->z);
#endif /* DEBUG */
...
#ifdef DEBUG
        hlog_printf(HLOG_LVL_INFO, HLOG_TAG_FUSION, "[addWeightedSample] alpha=%f\n", alpha);
#endif /* DEBUG */
...
#ifdef DEBUG
        hlog_printf(HLOG_LVL_INFO, HLOG_TAG_FUSION, "[addWeightedSample] add filteredData x=%f, y=%f, z=%f\n",
                this_->filteredData->x, this_->filteredData->y, this_->filteredData->z);
#endif /* DEBUG */
