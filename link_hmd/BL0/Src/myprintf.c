...
PUTCHAR_PROTOTYPE
{
	/*From \STM32Cube_FW_F4_V1.5.0\Projects\STM32F411RE-Nucleo\Examples\UART\
UART_Printf\Src*/
...
transmission */
	...
	/* General Options -> Library Options -> Printf formatter = Small, Scanf
formatter = Small*/
	...
	if (prev_ch != '\r') {
		HAL_UART_Transmit(&dbg_uart, (uint8_t *)"\r", 1, 0xFFFF);
		HAL_UART_Transmit(&dbg_uart, (uint8_t *)&ch, 1, 0xFFFF);
	}
